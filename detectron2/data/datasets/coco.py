...
def load_coco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    ...
    if dataset_name is not None:
        ...
        meta.thing_classes1 = thing_classes1
        meta.thing_classes2 = thing_classes2
        meta.thing_classes3 = thing_classes3
        ...
        if not (min(cat_ids_1) == 1 and max(cat_ids_1) == len(cat_ids_1)):
...
"""
        ...
        id_map_1 = {v: i for i, v in enumerate(cat_ids_1)}
        meta.thing_dataset_id_to_contiguous_id_1 = id_map_1
        
        id_map_2 = {v: i for i, v in enumerate(cat_ids_2)}
        meta.thing_dataset_id_to_contiguous_id_2 = id_map_2
        
        id_map_3 = {v: i for i, v in enumerate(cat_ids_3)}
        meta.thing_dataset_id_to_contiguous_id_3 = id_map_3
    ...
    ann_keys = ["iscrowd", "bbox", "keypoints", "category_id_1", "category_id_2", "category_id_3"] + (extra_annotation_keys or [])
    ...
    for (img_dict, anno_dict_list) in imgs_anns:
        ...
        for anno in anno_dict_list:
            ...
            if id_map_1:
                annotation_category_id = obj["category_id_1"]
                try:
            ...
            id_map_2 = False  
            if id_map_2:
                annotation_category_id = obj["category_id_2"]
                
                try:
                    obj["category_id_2"] = id_map_2[annotation_category_id]
                except KeyError as e:
                    if obj["category_id_2"]==None:
                      pass
                    else:
                      raise KeyError(
                          f"Encountered category_id={annotation_category_id} "
            ...
            id_map_3 = False
            if id_map_3:
                annotation_category_id = obj["category_id_3"]
                try:
                    obj["category_id_3"] = id_map_3[annotation_category_id]
                except KeyError as e:
                    if obj["category_id_3"]==None:
                      pass
                    else:
                      raise KeyError(
                          f"Encountered category_id={annotation_category_id} "
