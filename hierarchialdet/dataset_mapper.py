...
class DiffusionDetDatasetMapper:
    ...
    def __init__(self, cfg, is_train=True):
        ...
        # boxes_train = "/HierarchicalDet/bbox_diffusion/quadrant/train.json"
        # boxes_valid = "/VA_project/HierarchicalDet/bbox_diffusion/quadrant/valid.json"
        ...
        if "annotations" in dataset_dict:
           ...
           # print(dataset_dict)
            ...
            if usepretrainedboxes:
              ...
              annos = [
                  utils.transform_instance_annotations(obj, transforms, image_shape, bbox_pre=bboxpre)
