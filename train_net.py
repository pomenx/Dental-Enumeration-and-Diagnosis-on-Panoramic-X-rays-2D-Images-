...
if __name__ == "__main__":
    ...
    register_coco_instances('custom_train_class', {}, "../DENTEX/train_test_quadrant/train.json", "../DENTEX/images")
    ...
    register_coco_instances('custom_validation_class', {}, "../DENTEX/disease_test.json", "../DENTEX/images")
    launch(
        main,
        args.num_gpus,
